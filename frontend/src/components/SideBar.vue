...
<template>
  <header 
    class="sticky top-0 z-50 w-full shadow-xl bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900 border-b border-white/10 backdrop-blur-sm bg-opacity-95"
  >
    ...
    >
      <div v-show="menuAberto" class="fixed inset-0 z-40 md:hidden flex justify-end">
        
        <div class="absolute inset-0 bg-slate-900/60 backdrop-blur-sm" @click="fecharMenu"></div>

        <nav class="relative w-72 h-full bg-gradient-to-b from-blue-900 to-slate-900 shadow-2xl border-l border-white/10 flex flex-col p-6 pt-24 gap-2 overflow-y-auto">
